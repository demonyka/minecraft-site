...
<template>
    <div class="container">
        ...
        <form @submit.prevent="submit" spellcheck="false">
            ...
            />
            <McButton style="margin-top: 6px">Войти</McButton>
            <section class="sub-buttons">
                <McButton>Нет аккаунта?</McButton>
                <McButton>Забыли пароль?</McButton>
            </section>
            <McButton style="margin-top: 32px" @click="$inertia.visit(route('home'))">На главную</McButton>
        </form>
    </div>
</template>
